...
class Hare(battlechar.BattleChar):
    ...
    def createMoveFlipping(self):
        ...
        f = [ self.frameData(34, flippingSpeed, r[0]),
              self.frameData(23, flippingSpeed, r[0]),
              self.frameData(33, flippingSpeed, r[0]),
              self.frameData(24, flippingSpeed, r[0]),
    ...
    def createMoveJabA(self):
        ...
        f = [ self.frameData(41, 2, r[0]),
              self.frameData(42, 1, r[0], h[0]),
              self.frameData(43, 3, r[0]),
              self.frameData(43, 10, r[0])]
    ...
    def createMoveJab2(self):
        ...
        f = [ self.frameData(43, 2, r[0]),
              self.frameData(44, 2, r[1], h[0]),
              self.frameData(45, 9, r[2]),
    ...
    def createMoveDownA(self):
        ...
        f = [ self.frameData(29, 3, r[0]),
              self.frameData(30, 2, r[1], h[0]),
              self.frameData(31, 6, r[2]),
              self.frameData(32, 7, r[3]) ]
